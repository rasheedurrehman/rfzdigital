...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $secretKey = '6LdGh8AqAAAAAFrjqFV-Rm11q7jJHUbsiW-vWiy6';
            ...
            <div class="contact_main-content contact-content-space">
              <div class="content">
                <div class="content-text-block">
                  <h2 class="heading-md mobile-hide">Implementing Captcha </h2>
            ...
            <div class="form-box-style__form-wrapper bg-light-2">
              <form class="form-box-style" id="contact-form" method="POST" action="contact-us.php">
                ...
                <input id="phone" class="form-control bg-white" name="phone" type="tel" placeholder="Enter your phone number" required>
                  ...
                  <div class="form-box-style__form-input">
                  <div class="g-recaptcha mb-3" data-sitekey="6LdGh8AqAAAAAOtHZIUvMRJc-MwdR77IQ686gfXb
"></div>
                  </div>
