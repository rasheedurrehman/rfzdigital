...
<section class="custom-bg">
    <div class="container">
        <div class="row align-items-center">
            <!-- Left Column -->
            <div class="col-md-7">
                <h6 class="text-uppercase" style="color: #EC7D63;">Startup Website Design Services</h6>
                <h2 class="mb-3 com-services">We offer Affordable Website Solutions for your startup –<span
            ...
            <div class="col-md-5 d-flex justify-content-center">
                <img src="./image/digitalservices/wdd/startup-website-design-services.webp"
                    alt="Startup Website Design Services" class="img-fluid rounded  ">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="content">
                    <div class="content-text-block">
                        ...
                        <h2 class="content-title heading-md text-black">
                            Launching Ideas, Inspiring Growth
                        </h2>
                        <p>
                            At RFZ Digital, we provide professional startup website design services that empower
                            emerging businesses to make their mark. Our expert team combines innovative design with
                            strategic development to create websites that captivate audiences and maximise conversions.
                            RFZ Digital understands the unique challenges startups face, so we tailor our solutions to
                            ensure your business’s online presence is both impactful and effective in driving growth.
                        </p>
                ...
                <div class="col-xxl-8 col-lg-9 col-md-9 col-sm-12 col-xs-11">
                    <div class="section-heading">
                        <h2 class="section-heading__title heading-md heading-md--general-sans text-l5-secondary">
                            Innovative Websites to Kickstart Your Business Journey
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="accordion-style-1" id="home-1-faq">
                    <div class="accordion-item">
                        <button class="accordion-button " type="button" data-bs-toggle="collapse"
                            ...
                            What is included in your Startup Website Design Services?
                        </button>
                        <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                Our services include custom website design, mobile responsiveness, user-friendly
                                navigation, branding integration, SEO-friendly structure, and essential features like
                    ...
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            Why should startups invest in a professionally designed website?
                        </button>
                        <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                A well designed website helps establish credibility, attract potential investors and
                                customers, and showcase your startup’s vision. It’s your digital storefront and a vital
                    ...
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            How quickly can you design a startup website?
                        </button>
                        <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                We understand startups often need to move quickly. A standard startup website typically
                                takes 1–3 weeks, depending on the complexity and features required.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            Will the website be scalable as my startup grows?
                        </button>
                        <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                Yes, we design websites with scalability in mind, ensuring you can easily add features,
                                pages, or integrations as your startup expands.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            Can you help create content for my startup website?
                        </button>
                        <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                Absolutely! We can assist with professional content writing to clearly communicate your
                                startup’s mission, services, and unique value proposition.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            Will my startup website be SEO-friendly?
                        </button>
                        <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                Yes, we incorporate SEO best practices in the design process, ensuring your website
                                ranks well on search engines and attracts organic traffic.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                ...
                                and performance optimisation, ensuring your website runs smoothly.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            How much does it cost to design a startup website?
                        </button>
                        <div id="home-1-faq-item-8" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                            <div class="accordion-item__body">
                                Our startup website design packages start at $399. We also offer customised quotes based
                                on specific features and functionalities your startup requires.
                            </div>
                        </div>
                    </div>
                </div>
