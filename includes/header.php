...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/comservices.css">
    ...
    <meta property="og:description"
        content="RFZ Digital is providing professional website design, development and digital marketing services in UK & Ireland. We help businesses grow online & generate leads." />
                    ...
                    <div class="menu-block-wrapper ">
                        ...
                        <nav class="menu-block" id="append-menu-header">
                            ...
                            <ul class="site-menu-main">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo BASE_URL; ?>website-design"
                                        class="nav-link-item drop-trigger">Website Design</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo BASE_URL; ?>seo" class="nav-link-item drop-trigger">SEO</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo BASE_URL; ?>social-media-marketing"
                                        class="nav-link-item drop-trigger">Social Media Marketing</a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo BASE_URL; ?>graphic-design"
                                        class="nav-link-item drop-trigger">Graphic Design</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://softwaredevs.team/" class="nav-link-item drop-trigger"
                                        target="_blank">Talent</a>
                                </li>
