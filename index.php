...
<style>
    ...
    @media (max-width: 600px) {
        ...
        .hero-section {
            background-image: url('./image/home-1/index-page-hero-image.webp'); /* Update with your image path */
...
solutions. We specialise in boosting your online visibility, attracting your ideal audience, and driving measurable results that fuel long-term growth.
                        </p>
                    </div>
  ...
  <div class="row justify-content-center text-center">
            <div class="col-xxl-6 col-lg-7 col-md-9 col-sm-12 col-xs-11">
              <div class="section-heading">
                <h2 class="section-heading__title heading-md heading-md--general-sans text-l5-secondary section-3-heading">Why Choose Our Digital Marketing &amp; Technology Services?</h2>
              </div>
            </div>
          </div>
        ...
        <div class="section-heading section-heading--row">
          <div class="row justify-content-center text-center text-lg-initial justify-content-lg-between social-icon-heading-button">
            <div class="col-xxl-8 col-xl-7 col-lg-8 col-md-9 ">
              <h2 class="section-heading__title heading-md heading-md--general-sans text-l5-secondary">Elevate your Business online presence with Digital & Technology Solutions</h2>
            </div>
     ...
     <div class="section-heading section-heading--row">
          <div class="row text-center text-lg-initial justify-content-center justify-content-lg-between">
            <div class="col-xxl-9 col-lg-7 col-md-9 col-11">
              <h2 class="section-heading__title testimonial-heading-md text-black reviews-heading">Join Our Happy Clients – Let’s Elevate Your Business!</h2>
            </div>
