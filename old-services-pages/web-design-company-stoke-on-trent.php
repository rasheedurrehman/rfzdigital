...
$meta_title = "Need a Website? Top Web Design in Stoke on Trent!";
$meta_description = "Web Design company stoke on trent that delivers results. Discover why businesses trust us to create websites that convert! Get started with a free consultation!";
$canonical_url = "https://rfzdigital.co.uk/web-design-company-stoke-on-trent";
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-7 s-h-text-content">
                <h1 class="text-uppercase text-muted service-hero-h1">Web Design Company Stoke on Trent</h1>
                    <h2 class="mb-3 service-hero-heading">Professional website design solutions for your <span style="color:#1463FF; white-space:normal;"> Business to Grow Online </span></h2>
                    <p class="mb-3 services-hero-text">Enhance your business presence in Stoke-on-Trent with a professional website. Our expert team designs responsive, SEO-optimised websites that provide an excellent user experience and increase your online visibility. Whether you are a new or an established business in Stoke-on-Trent, we offer customised web design solutions that help you connect with your local audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 s-h-img">
                    <img src="./image/services/hero-section/stoke-on-trent.webp" alt="Web Design Company Stoke on Trent" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Empowering UK and Ireland Companies to Thrive Online with Stunning Website Design

                </h2>
                <p>
                  At RFZ Digital, we empower UK and Ireland companies to thrive online with stunning website design. Our team creates visually captivating, responsive websites that boost brand visibility, engage customers, and drive growth.
                </p>
              </div>
...
<div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>8We develop sleek, fast-loading websites that prioritise both aesthetics and performance to maximise user satisfaction.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Web Security Excellence</h5> <!-- Heading -->
        <p>We design security-optimised websites that ensure safe transactions and customer confidence.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We ensure your website is structured for search engine success and optimised for mobile users.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We build websites with a structured interface, ensuring you can update content without confusion.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We help you launch a beautiful, fast, and functional website at a price that works for your business, ensuring you get the best value.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We work closely with you to create a website that not only looks great but also delivers real results.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/37.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Innovating Business Solutions for UK, Ireland, and Global Markets

                </h2>
                <p>At RFZ Digital, we provide SEO-optimised, high-performance website design that drives business growth and strengthens your online presence. Our fast, mobile-friendly, and user-focused websites are crafted to boost visibility, engage customers, and improve conversions.</p>
                <p>Serving businesses in the UK, Ireland, and worldwide, we specialise in responsive, search engine-friendly websites that deliver measurable results. Whether you are launching a new website or redesigning an existing one, our innovative solutions are designed to help your business succeed in a competitive digital landscape.</p>
                <p>Partner with RFZ Digital to unlock innovative business solutions and drive success today!
</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Stoke-on-Trent?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Most websites are delivered within 2-4 weeks, with more complex projects taking 4-6 weeks. We collaborate closely with you to ensure your Stoke-on-Trent business website is developed on time and meets your specific needs and goals.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Stoke-on-Trent?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer local SEO services tailored to businesses in Stoke-on-Trent. Our strategies are designed to improve your website ranking in local search results, helping you attract more customers in Stoke-on-Trent and the surrounding areas.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Stoke-on-Trent?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide ongoing website maintenance services to ensure your Stoke-on-Trent business website stays secure, updated, and running smoothly. Our services include regular updates, security checks, and performance optimisation to maintain your site’s effectiveness.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Stoke-on-Trent?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure, intuitive e-commerce websites for businesses in Stoke-on-Trent. Our e-commerce solutions are designed to offer a seamless shopping experience and help maximise your sales and customer satisfaction.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Stoke-on-Trent?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! Every website we build is mobile-responsive, ensuring that your Stoke-on-Trent customers have a smooth and enjoyable experience on smartphones, tablets, and desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Stoke-on-Trent?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, perform regular security audits, and use advanced malware protection to ensure your Stoke-on-Trent business website is secure and protected from cyber threats, safeguarding your data and your customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Stoke-on-Trent?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup as part of our web development services. This helps your Stoke-on-Trent business maintain a professional image and enables smooth communication with clients and partners.
                  </div>
                </div>
              </div>
