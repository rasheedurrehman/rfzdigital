...
<?php
$noindex = true;
$meta_title = "Web Design Armagh | Website Development | RFZ Digital UK";
$meta_description = "Need a business web design in Armagh? Our expert team designs professional and high-performing websites that deliver real results. Get started now!";
$canonical_url = "https://rfzdigital.co.uk/web-design-armagh";
...
@media (max-width: 600px) { /* Mobile View */
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web Design Armagh</h1>
                    <h2 class="mb-3 service-hero-heading">Get a professional website design that <span style="color:#1463FF; white-space:normal;">Drives Results </span></h2>
                    <p class="mb-3 services-hero-text">Strengthen your business presence in Armagh with a professional website. Our expert team designs responsive, SEO-optimised websites that provide an excellent user experience and increase your online visibility. Whether you're a new business or an established brand in Armagh, we offer customised web design solutions that help you connect with your local audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Armagh.webp" alt="Web Design Armagh" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
          ...
          <div class="offset-xl-0 col-xl-6 col-lg-7 col-md-6" data-aos-duration="1000" data-aos="fade-left">
            <div class="content">
              <div class="content-text-block">
                ...
                Unlocking Business Potential with Professional Website Design for UK and Ireland Companies
                </h2>
                <p>
                  At RFZ Digital, we unlock business potential with professional website design for UK and Ireland companies. Our expert team creates custom, responsive websites that enhance user experience, elevate your brand, and drive business success.
...
<div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design fast, modern websites that offer seamless navigation and a top-notch browsing experience.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Reliable Website Protection</h5> <!-- Heading -->
        <p>We develop cyber-secure websites that comply with industry security standards and regulatory requirements.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that are responsive, search engine optimised, and designed for business growth.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Our websites allow you to make real-time updates with zero coding, keeping your online presence dynamic and fresh.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>Get more for less, our competitively priced web design services give you professional results without breaking the bank.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>Your success is our priority, which is why we create tailored web solutions that help you connect with your customers effectively.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/56.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Creating Digital Impact Across UK, Ireland, and the Worldwide

                </h2>
                <p>At RFZ Digital, we specialise in delivering SEO-optimised, high-performance websites that make a lasting impact. Our mobile-friendly, fast, and user-centred designs are designed to elevate your business, boost visibility, and drive conversions, ensuring your business thrives in the UK, Ireland, and globally.</p>
                <p>We focus on developing responsive, search engine-friendly websites that provide seamless user experiences and measurable results. Whether launching a new website or refining your digital presence, our tailored solutions are designed to help your business grow and stand out.</p>
                <p>Partner with RFZ Digital today and create a digital impact that reaches far beyond your expectations!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Armagh?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Typically, it takes between 2-4 weeks to complete a website, depending on complexity. More advanced projects may take 4-6 weeks. We ensure regular communication throughout the process to meet your timeline and business objectives in Armagh.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Armagh?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer local SEO services tailored to businesses in Armagh. Our team uses strategies that enhance your website’s visibility in local search results, helping you attract more customers from Armagh and surrounding areas.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Armagh?

                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance for businesses in Armagh. This includes regular updates, security checks, and optimisations to keep your website secure, fast, and fully operational, ensuring that it continues to meet your business needs.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Armagh?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure, user-friendly e-commerce websites for businesses in Armagh. Our e-commerce solutions are designed to improve the shopping experience, increase conversions, and help you grow your business online.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Armagh?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All our websites are mobile-responsive, ensuring that your customers in Armagh have a seamless experience on any device, whether they are browsing from a smartphone, tablet, or desktop.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Armagh?

                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We prioritise security by implementing SSL certificates, performing regular security audits, and using advanced malware protection to safeguard your Armagh business website. These measures protect your site and your customers data from potential cyber threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Armagh?

                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup services as part of our website development package for businesses in Armagh. This helps your business maintain a professional image and ensures seamless communication with clients, customers, and partners.
                  </div>
                </div>
              </div>
