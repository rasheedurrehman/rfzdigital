...
<section class="custom-bg">
        <div class="container">
            <div class="row align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="text-uppercase text-muted services-heading-h1" >Web Design Edinburgh</h1>
                    <h2 class="mb-3 services-heading-h2">Professional and affordable web design services for  <span style="color:#318CB8; white-space:normal;">Your Business</span></h2>
                    <p class="mb-4">Enhance your business presence in Edinburgh with a professional website. Our expert team designs responsive, SEO-optimised websites that offer a seamless user experience and increase your online visibility. Whether you're a new startup or an established brand in Edinburgh, we provide customised web design solutions that help you connect with your audience and stand out in a competitive digital market.</p>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Helping UK and Ireland Enterprises Succeed with Impactful Website Design Services
                </h2>
                <p>
                 At RFZ Digital, we help UK and Ireland enterprises succeed with impactful website design services. Our team designs responsive, visually engaging websites that improve user experience, strengthen brand identity, and drive business success.
                </p>
              </div>
        ...
        <div class="row row--custom">
          ...
          <div class="col-xl-6 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Building a Digital Future Across UK, Ireland, and Global

                </h2>
                <p>At RFZ Digital, we specialise in SEO-optimised, high-performance website design that shapes the digital future of businesses. Our fast, mobile-friendly, and user-focused websites are designed to boost your online presence, enhance engagement, and drive conversions.</p>
                <p>Serving businesses across the UK, Ireland, and worldwide, we design responsive, search engine-friendly websites that deliver long-term results. Whether launching a new website or revamping an existing one, our innovative digital solutions are crafted to build a successful digital future for your business.</p>
                <p>Partner with RFZ Digital today to start building your digital future!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Edinburgh?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Typically, websites are completed within 2-4 weeks. For more complex websites, the process may take 4-6 weeks. We ensure that your Edinburgh business website is delivered on time, meeting all your requirements.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
               ...
               Do you offer local SEO services for businesses in Edinburgh?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services to help businesses in Edinburgh increase their visibility in search engine results. Our SEO strategies are designed to attract more local traffic to your website, helping you connect with more customers in the Edinburgh area.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Edinburgh?

                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to ensure your Edinburgh business website stays secure, updated, and functioning at its best. This includes regular updates, security checks, and performance optimisation.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Edinburgh?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure, user-friendly e-commerce websites for businesses in Edinburgh. Our e-commerce solutions are designed to enhance the shopping experience for your customers and help you grow your online sales.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Edinburgh?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all our websites are mobile-responsive. This ensures that your customers in Edinburgh, whether on smartphones, tablets, or desktops, will have an optimal experience when visiting your website.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Edinburgh?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                   We take website security seriously by implementing SSL certificates, conducting regular security audits, and applying advanced malware protection. This ensures that your Edinburgh business website is secure and that your customer data is safe from cyber threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Edinburgh?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup as part of our web development services. This helps your Edinburgh business maintain a professional image and facilitates effective communication with clients, partners, and customers.
                  </div>
                </div>
              </div>
