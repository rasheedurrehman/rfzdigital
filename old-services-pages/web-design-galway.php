...
<?php
$meta_title = "Web Design Galway | Website Design Services | RFZ Digital";
$meta_description = "Grow your business with our web design services in Galway. RFZ Digital specializes in high-performance, SEO-friendly web design. Get started today.";
$canonical_url = "https://rfzdigital.co.uk/web-design-galway";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web Design Galway</h1>
                    <h2 class="mb-3 service-hero-heading">Online growth made easy with a professional <span style="color:#1463FF; white-space:normal;">Website Design </span></h2>
                    <p class="mb-3 services-hero-text">Boost your business presence in Wakefield with a professional website. Our expert team designs responsive, SEO-optimised websites that offer an exceptional user experience and enhance your online visibility. Whether you are a new or an established business in Wakefield, we provide customised web design solutions that help you connect with your local audience and stand out in a competitive market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/galway.webp" alt="Web Design Galway" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                 Designing Stunning Websites That Make UK and Ireland Businesses Stand Out Online
                </h2>
                <p>
                  At RFZ Digital, we design stunning websites that make UK and Ireland businesses stand out online. Our team focuses on creating visually striking, responsive websites that engage users, amplify brand identity, and drive business growth.
                </p>
              </div>
...
<div class="row row1">
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        <div class="feature-widget-2__icon">
                  <img src="./image/services/icons/Modern-Website-Design.svg" alt="High-Quality Web Design">
                </div>
        <!-- <div class="icon">📈</div>  -->
        <h3>High-Quality Web Design</h3> <!-- Heading -->
        <p>Our expert team design Professional, modern websites that enhance user engagement and business growth.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        <div class="feature-widget-2__icon">
                  <img src="./image/services/icons/Highly-Secured-Websites.svg" alt="Advanced Website Safety">
                </div>
        <!-- <div class="icon">🌐</div>  -->
        <h3>Advanced Website Safety</h3> <!-- Heading -->
        <p>Stay ahead of cyber threats with our highly secured websites, designed to keep your data and users safe.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>Our websites are designed to attract more visitors with SEO best practices ensuring a best mobile experience.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design websites that simplify your workflow. Manage content, add pages, and update details with zero hassle.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We make professional websites accessible to all businesses with cost-effective, transparent pricing.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We work closely with you to ensure your website reflects your Business identity and business objectives.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/pbhtxpi1tdgmmmihzzin.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Elevating Ireland and UK Businesses to Digital Heights

                </h2>
                <p>At RFZ Digital, we empower businesses across the UK, Ireland, and beyond with cutting-edge digital solutions. From website design to SEO, digital marketing, and advanced tech services, we help businesses scale, innovate, and stay ahead in the digital era.</p>
                <p>Your success is our mission; let’s take your business to new digital heights!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Galway?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  The development process typically takes 2-4 weeks, depending on the complexity of your website. For more advanced websites, it may take 4-6 weeks. We communicate with you throughout the project to ensure the final product aligns with your expectations and business goals in Galway.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Galway?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide local SEO services to businesses in Galway. Our approach is customised to enhance your website visibility in local search results, helping you attract more customers from Galway and the surrounding areas, driving organic traffic to your site.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Galway?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer comprehensive website maintenance services for businesses in Galway. We ensure your website remains secure, up-to-date, and optimised, so you can focus on running your business while we take care of the technical side.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Galway?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! We specialise in building secure, scalable e-commerce websites for businesses in Galway. Our e-commerce solutions are designed to enhance the customer shopping experience, boost conversions, and support the growth of your online store.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Galway?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all websites we create are fully mobile-responsive. This ensures that your customers in Galway can easily navigate your website on any device, from smartphones to tablets, providing an optimal browsing experience wherever they are.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Galway?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement advanced security measures, including SSL certificates, regular security audits, and malware protection, to ensure your website remains safe from cyber threats. This protects both your business and your customers' sensitive data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Galway?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup as part of our website development package. This helps businesses in Galway communicate with customers in a professional manner, enhancing your Business credibility and ensuring smooth communication.
                  </div>
                </div>
              </div>
