...
<section class="custom-bg">
        <div class="container">
            <div class="row align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="text-uppercase text-muted services-heading-h1" >Web design Manchester</h1>
                    <h2 class="mb-3">Engage with your customers with a beautifully <span style="color:#318CB8; white-space:normal;">Designed Website </span></h2>
                    <p class="mb-4">Enhance your business presence in Manchester with a professional website. Our expert team designs responsive, SEO-optimised websites that deliver a seamless user experience and improve your online visibility. Whether you are a new or an established business in Manchester, we offer customised website design solutions that help you stand out and effectively engage with your target audience in a competitive market.</p>
