...
$meta_title = "Website Design York | Professional Website Design Services";
$meta_description = "Partner with RFZ Digital for professional website design in York. We deliver scalable, mobile-optimized websites that fuel your business growth.";
$canonical_url = "https://rfzdigital.co.uk/website-design-york";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design York</h1>
                    <h2 class="mb-3 service-hero-heading">Reach more customers with a modern <span style="color:#1463FF; white-space:normal;">Business Website Solution </span></h2>
                    <p class="mb-3 services-hero-text">Strengthen your business presence in York with a professional website. Our expert team creates responsive, SEO-optimised websites that ensure a seamless user experience and improve your online visibility. Whether you are a new business or an established brand in York, we offer customised web design solutions that help you connect with your audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/York.webp" alt="Website Design York" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Innovative Website Design for UK and Ireland Brands Ready to Excel Online
                </h2>
                <p>
                  At RFZ Digital, we offer innovative website design for UK and Ireland brands ready to excel online. Our team creates responsive, user-focused websites that elevate brand presence, engage customers, and drive growth.
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design fast, mobile-friendly websites that provide visitors with an exceptional browsing experience and encourage higher engagement.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Maximum Web Safety</h5> <!-- Heading -->
        <p>We secure your website with multi-layered protection, ensuring safety against unauthorised access.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites with responsive design and SEO strategies, ensuring top performance on search engines and mobile devices.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Our websites are designed for business, managing a business website is quick and frustration-free.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We offer affordable business website design solutions that don’t sacrifice quality or functionality.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We combine creativity with strategy, ensuring your website is not only beautiful but also serves its purpose in growing your business.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/9.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Leading the Way in Digital Innovation Across UK, Ireland, and Globally

                </h2>
                <p>At RFZ Digital, we drive SEO-optimised, high-performance website design that sets your business apart in the digital landscape. Our fast, mobile-friendly, and user-centric websites are crafted to enhance visibility, boost engagement, and drive conversions.</p>
                <p>With deep expertise in serving businesses across the UK, Ireland, and globally, we specialise in designing responsive, search engine-friendly websites that deliver measurable, long-term results. Whether you're launching a new website or revamping an existing one, our innovative solutions lead the way in digital transformation, empowering your business to thrive.</p>
                <p>Partner with RFZ Digital today and lead your industry with cutting-edge digital innovation!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in York?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Websites are typically completed within 2-4 weeks, while more complex projects may take up to 4-6 weeks. We work closely with you to ensure your York business website is delivered on time and is according to your specific needs.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in York?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services for businesses in York. Our strategies help boost your website ranking in local search results, ensuring that your business is easily found by potential customers in the York area.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in York?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to ensure your York business website remains secure, updated and performs optimally. This includes regular updates, security checks, and performance improvements.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in York?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in creating secure, user-friendly e-commerce websites for businesses in York. Our e-commerce solutions are designed to provide a seamless shopping experience, helping you increase online sales and grow your business.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in York?

                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All websites we create are mobile-responsive, ensuring your York customers have an optimal browsing experience across all devices, from smartphones to desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in York?

                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, conduct regular security audits, and use advanced malware protection to ensure your York business website is secure. Our comprehensive approach helps protect both your website and customer data from potential threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in York?

                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup as part of our web development services. This helps your York business maintain a professional image and enables efficient communication with clients, partners, and customers.
                  </div>
                </div>
              </div>
