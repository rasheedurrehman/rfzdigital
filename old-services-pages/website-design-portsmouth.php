...
$meta_title = "Website Design Portsmouth | Modern & Engaging Websites";
$meta_description = "Looking for professional website design in Portsmouth? RFZ Digital delivers high-quality, SEO-optimized websites that drive growth. Get started now!";
$canonical_url = "https://rfzdigital.co.uk/website-design-portsmouth";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design Portsmouth</h1>
                    <h2 class="mb-3 service-hero-heading">Expand your reach with a sleek and <span style="color:#1463FF; white-space:normal;">Professional Website </span></h2>
                    <p class="mb-3 services-hero-text">Boost your business presence in Portsmouth with a professional business website. Our expert team designs responsive, SEO-optimised websites that provide an exceptional user experience and improve your business online visibility. Whether you are a new startup or an established business in Portsmouth, we offer customised web design solutions that help you engage with your local audience and stand out in a competitive market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Portsmouth.webp" alt="Website Design Portsmouth" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Developing Websites That Elevate UK and Ireland Businesses Online
                </h2>
                <p>
                  At RFZ Digital, we design websites that elevate UK and Ireland businesses online. Our expert team designs responsive, visually compelling websites that enhance user experience, build business identity, and drive growth.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design high-speed websites that ensure smooth interactions, faster page loads, and an overall better digital experience.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Ultimate Web Protection</h5> <!-- Heading -->
        <p>We keep your business website safe with advanced security protocols, regular updates, and threat detection.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design search-friendly, mobile-responsive websites that adapt perfectly to every device and screen size.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Our websites allow you to take charge of content updates with a seamless, straightforward management system.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We provide professional web design at an accessible price, making it easy for startups and small businesses to compete online.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We focus on delivering results-driven websites that not only look great but also help your business thrive in the digital world.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/11.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Your Partner in Digital Success Across UK, Ireland, and Worldwide
                </h2>
                <p>At RFZ Digital, we specialise in SEO-optimised, high-performance website design that drives business growth and strengthens your digital presence. Our fast, mobile-friendly, and user-focused websites are designed to increase online visibility, engage customers, and improve conversions.</p>
                <p>Serving businesses in the UK, Ireland, and globally, we design responsive, search engine-friendly websites that deliver measurable results. Whether you need a new website or a redesign, our expert solutions are tailored to help your business succeed in a competitive digital landscape.</p>
                <p>Partner with RFZ Digital for lasting digital success today!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to design a website for my business in Portsmouth?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Most websites are completed within 2-4 weeks, while more complex projects may take 4-6 weeks. We work closely with you to ensure your Portsmouth business website meets your specific needs and is delivered on time without compromising quality.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Portsmouth?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer local SEO services tailored to Portsmouth businesses. Our SEO strategies are designed to improve your website ranking in local search results, helping you attract more customers from the Portsmouth area and expand your online presence.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Portsmouth?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to keep your Portsmouth business website secure, up-to-date, and performing optimally. This includes regular updates, security monitoring, and performance optimisation to ensure your website remains effective in the long term.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you design an e-commerce website for my business in Portsmouth?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure, user-friendly e-commerce websites for Portsmouth businesses. Our e-commerce solutions are designed to enhance the online shopping experience and boost sales for your business.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Portsmouth?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All of our websites are mobile-responsive, ensuring a seamless browsing experience for your Portsmouth customers, whether on smartphones, tablets, or desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Portsmouth?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We ensure your Portsmouth business website is protected by implementing SSL certificates, performing regular security audits, and using advanced malware protection. Our goal is to safeguard your website and customer data from cyber threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Portsmouth?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup as part of our web design services package. This ensures that your Portsmouth business maintains a professional image and allows for smooth communication with clients and partners.
                  </div>
                </div>
              </div>
