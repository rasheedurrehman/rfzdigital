...
$meta_title = "Expert Website Design Dublin | RFZ Digital";
...
$canonical_url = "https://rfzdigital.co.uk/website-design-dublin";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design Dublin</h1>
                    <h2 class="mb-3 service-hero-heading">We design Business websites that <span style="color:#1463FF; white-space:normal;">Bring Sales</span></h2>
                    <p class="mb-3 services-hero-text">Enhance your business presence in Dublin with a professional website. Our expert team designs responsive, SEO-optimised websites that offer a seamless user experience and boost your online visibility. Whether you are a new business or an established brand in Dublin, we provide customised web design solutions that help you connect with your audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Dublin.webp" alt="Website Design Dublin" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design Modern Business websites that are fast, user-friendly, and designed to make your business stand out and thrive online.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We design secure web solutions that protect your business from cyber threats, ensuring data privacy, reliability, and peace of mind.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that are fully optimised for search engines and mobile devices, ensuring better rankings and seamless user experience.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design websites with easy-to-use dashboards, allowing you to manage content effortlessly. No technical skills needed.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We offer high-quality website design at budget-friendly prices, ensuring you get a professional online presence without overspending.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We prioritise your needs, working closely with you to create a website that aligns with your vision, goals, and business objectives.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/1.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Digital Excellence Delivered in Ireland, UK, and Worldwide

                </h2>
                <p>At RFZ Digital, we specialise in delivering cutting-edge digital solutions that empower businesses to thrive in a fast-evolving world. From high-performance web design and development to SEO, digital marketing, and advanced technology solutions, we ensure your business stands out in competitive markets across the UK, Ireland, and beyond.</p>
                <p>We offer mobile-friendly, SEO-optimised websites, innovative marketing strategies, and seamless digital experiences that drive growth, engagement, and success for businesses of all sizes.</p>
                <p>Partner with RFZ Digital today and take your business to new heights with our world-class digital excellence!
</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Dublin?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  The typical timeframe for a website development project is 2-4 weeks, depending on the complexity of the site. More complex projects may take 4-6 weeks. We work closely with you throughout the process to ensure your website is completed on time and to your satisfaction.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Dublin?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer specialised local SEO services to help your business in Dublin rank higher in local search results. Our tailored strategies aim to increase your visibility and attract more customers from the Dublin area and beyond.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Dublin?

                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer comprehensive website maintenance services for businesses in Dublin. Our team ensures that your website is regularly updated, secure, and optimised for performance, allowing you to focus on your business while we take care of your website needs.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Dublin?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! We specialise in designing secure, scalable, and easy-to-use e-commerce websites for businesses in Dublin. Our e-commerce solutions are designed to enhance the shopping experience, increase conversions, and support the growth of your online business..
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Dublin?

                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all of our websites are fully mobile-responsive. This ensures that your customers in Dublin can easily access and navigate your website, whether they are on a smartphone, tablet, or desktop.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Dublin?

                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We take security seriously and implement SSL certificates, regular security audits, and advanced malware protection to ensure your website is safe from cyber threats. This protects your business and customer data, giving you peace of mind.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Dublin?

                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup services as part of our website development package. This allows your Dublin-based business to maintain a professional image and communicate effectively with clients, customers, and partners.
                  </div>
                </div>
              </div>
