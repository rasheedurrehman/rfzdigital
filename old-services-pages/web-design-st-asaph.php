...
<section class="custom-bg">
        <div class="container">
            <div class="row align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="text-uppercase text-muted services-heading-h1" >Web Design St Asaph</h1>
                    <h2 class="mb-3 services-heading-h2">Empower your business with a professionally <span style="color:#318CB8; white-space:normal;"> Designed Website </span></h2>
                    <p class="mb-4">Enhance your business presence in St Asaph with a professional website. Our expert team creates responsive, SEO-optimised websites that provide a seamless user experience and improve your online visibility. Whether you are a new business or an established brand in St Asaph, we offer customised web design solutions that help you connect with your local audience and stand out in a competitive market.</p>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Building Digital Success for UK and Ireland Businesses with Expert Website Design Services.
                </h2>
                <p>
                  At RFZ Digital, we build digital success for UK and Ireland businesses with expert website design services. Our team creates custom, responsive websites that enhance user experience, showcase your business, and drive growth.
                </p>
              </div>
        ...
        <div class="row row--custom">
          ...
          <div class="col-xl-6 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Your Technology partner for UK, Ireland, and Global Excellence

                </h2>
                <p>At RFZ Digital, we are your trusted partner in delivering SEO-optimised, high-performance website design that drives growth and excellence. Our fast, mobile-friendly, and user-focused websites are designed to enhance visibility, foster engagement, and increase conversions, helping you achieve success in a competitive digital world.</p>
                <p>We specialise in building responsive, search engine-friendly websites that empower businesses in the UK, Ireland, and globally. Whether launching a new website or upgrading your existing one, our expert solutions are designed to ensure your digital presence is innovative, impactful, and future-proof.</p>
                <p>Partner with RFZ Digital today and experience the leadership in technology that fuels global success!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in St Asaph?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services for businesses in St Asaph. Our SEO strategies are designed to help your website rank higher in local search results, attracting more customers from St Asaph and the surrounding areas.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in St Asaph?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to businesses in St Asaph. Our services include regular updates, security monitoring, and performance checks to ensure your website stays secure, up-to-date, and functioning optimally.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in St Asaph?

                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in designing secure and user-friendly e-commerce websites for businesses in St Asaph. Our solutions help businesses enhance their online sales, providing a smooth shopping experience for your customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in St Asaph?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all websites we develop are mobile-responsive, ensuring that your customers in St Asaph can easily navigate your website on smartphones, tablets, and desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in St Asaph?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  We use SSL certificates, conduct regular security audits, and employ advanced malware protection to ensure your St Asaph business website is secure. These measures help protect your site from potential threats and safeguard customer data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in St Asaph?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    Yes, we provide professional email setup services as part of our web development offering. This helps your St Asaph business maintain a professional image and ensures smooth communication with clients, partners, and customers.
                  </div>
                </div>
              </div>
