...
<?php
$noindex = true;
$meta_title = "Website Design St Davids | Modern & Responsive Web Designs";
$meta_description = "Transform your online presence with our expert website design in St Davids. We create SEO-friendly, mobile-responsive sites that help your business grow online.";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design St Davids</h1>
                    <h2 class="mb-3 service-hero-heading">Affordable website design solutions that <span style="color:#1463FF; white-space:normal;"> Deliver Results </span></h2>
                    <p class="mb-3 services-hero-text">Boost your business presence in St Davids with a professional website. Our expert team designs responsive, SEO-optimised websites that offer a seamless user experience and enhance your online visibility. Whether you are a new business or an established brand in St Davids, we provide customised web design solutions that help you connect with your local audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/St-Davids.webp" alt="Website Design St Davids" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Redefining Business Success with Dynamic Website Design for UK and Ireland
                </h2>
                <p>
                  At RFZ Digital, we redefine business success with dynamic website design for UK and Ireland businesses. Our expert team designs responsive, engaging websites that improve user experience, strengthen your business and drive measurable growth.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <!-- <div class="icon">📈</div>  -->
        <h5>Modern Website Solutions</h5> <!-- Heading -->
        <p>We develop Modern, high-performing websites that offer an effortless and enjoyable browsing experience.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Secure Web Solutions</h5> <!-- Heading -->
        <p>We protect your website with high-end cybersecurity solutions, ensuring safe transactions and customer trust.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that are optimised for search engines and fully responsive, ensuring your business reaches the right audience on any device.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design websites with an intuitive content editor, so you can modify text, upload images, and publish new content effortlessly.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We help businesses thrive with reasonably priced web design services that don’t compromise on quality.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that not only attract visitors but also convert them into loyal customers, helping you grow your business online.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/60.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Supporting Your Digital Ambitions in UK, Ireland, and Worldwide
                </h2>
                <p>At RFZ Digital, we are dedicated to turning your digital ambitions into reality with SEO-optimised, high-performance website design. Our fast, mobile-friendly, and user-focused websites are designed to increase visibility, drive traffic, and maximise conversions.</p>
                <p>We specialise in creating responsive, search engine-friendly websites that empower businesses in the UK, Ireland, and beyond to succeed in the digital world. Whether starting a new project or enhancing an existing website, our digital solutions will help you achieve your goals and reach new heights.</p>
                <p>Partner with RFZ Digital today and let us support your journey towards digital success on a global scale!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in St Davids?
              ...
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in St Davids?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services tailored to businesses in St Davids. Our SEO strategies are designed to help your business appear in local search results, improving visibility and driving more customers from St Davids and the surrounding area.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in St Davids?

                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer comprehensive website maintenance services to businesses in St Davids. Our maintenance services include regular updates, security monitoring, and performance checks, ensuring your website remains secure and fully functional.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in St Davids?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we build secure and user-friendly e-commerce websites for businesses in St Davids. Our e-commerce solutions are designed to provide an excellent shopping experience and help your business increase online sales.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in St Davids?

                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All websites we create are mobile-responsive, ensuring that your customers in St Davids have a great experience whether they visit your website on a smartphone, tablet, or desktop.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in St Davids?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, conduct regular security audits, and use advanced malware protection to ensure your St Davids business website is secure. These measures help protect your site and customer data from cyber threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in St Davids?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup services as part of our web development package. This ensures that your St Davids business maintains a professional image and can communicate effectively with clients, partners, and customers.
                  </div>
                </div>
              </div>
