...
$meta_title = "Website Design Newcastle Upon Tyne – RFZ Digital";
$meta_description = "Modern, user-focused web design in Newcastle Upon Tyne. We create stunning, SEO-optimized websites that deliver exceptional experiences and drive actual results";
$canonical_url = "https://rfzdigital.co.uk/website-design-newcastle";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web design Newcastle</h1>
                    <h2 class="mb-3 service-hero-heading">Boost your business with a professional website Design Services <span style="color:#1463FF; white-space:normal;">Website Design Services </span></h2>
                    <p class="mb-3 services-hero-text">Strengthen your business presence in Newcastle upon Tyne with a professional business website. Our expert team designs responsive, SEO-optimised websites that ensure a smooth user experience and improve your online visibility. Whether you are a new startup or an established business in Newcastle, we offer customised web design solutions that help you stand out and effectively connect with your target audience in the competitive digital space.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Newcastle.webp" alt="Web design Newcastle" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Custom Website Design Solutions for UK and Ireland Leading Businesses
                </h2>
                <p>
                  At RFZ Digital, we offer custom website design solutions for UK and Ireland leading businesses. Our expert team designs unique, responsive websites that reflect your business identity, engage your audience, and drive growth.
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <!-- <div class="icon">📈</div>  -->
        <h5>Elegant Website Design</h5> <!-- Heading -->
        <p>We design powerful, modern websites that prioritise speed, security, and performance to help your business succeed online.</p>
      </div>
    </div>
<!-- Box 2 -->
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Ultimate Web Security</h5> <!-- Heading -->
        <p>We provide cutting-edge security solutions to keep your website, data, and users safe.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We develop SEO-focused, mobile-friendly websites to help your business stay ahead of the competition.</p>
      </div>
    </div>
  ...
  <div class="row g-4">
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites with non-tech users in mind, ensuring you can manage your website without external help.</p>
      </div>
    </div>
    <!-- Box 1 -->
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Get a website that looks and performs like a high-end solution at a price you can afford.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We take the time to understand your industry and audience, designing a website that helps you connect with your customers effortlessly.</p>
      </div>
    </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/7.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital – Your Website Design Partner in the UK & Ireland
                </h2>
                <p>Looking for professional website design in Newcastle? At RFZ Digital, we create modern, fast, and mobile-friendly websites that help your business stand out online. Our expert team focuses on user experience, clear design, and strong SEO to help you get more traffic and more customers.</p>
                <p>Whether you’re launching a new site or redesigning an existing one,  we build websites that look great and work even better. With a focus on local businesses in Newcastle, we understand what it takes to succeed online in today’s competitive market.</p>
                <p>Get a website that works as hard as you do – choose RFZ Digital.</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to design a website for my business in Newcastle upon Tyne?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Typically, we complete most websites within 2-4 weeks, with more complex websites taking 4-6 weeks. We work closely with our clients to ensure their website meets their specific needs and is delivered on time.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Newcastle upon Tyne?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer local SEO services designed to improve your business website visibility in Newcastle upon Tyne and surrounding areas. Our SEO strategies are focused on helping your business rank higher in local search results and attract more local customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Newcastle upon Tyne?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to keep your Newcastle upon Tyne business website up to date, secure, and functioning optimally. Our maintenance services include regular updates, security monitoring, and performance checks.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Newcastle upon Tyne?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure and user-friendly e-commerce websites for businesses in Newcastle upon Tyne. Our solutions are designed to optimise your online store and provide a seamless shopping experience for your customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Newcastle upon Tyne?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                 Yes, all of our websites are mobile-responsive, ensuring they look and perform well across smartphones, tablets, and desktops. This is especially important for improving customer engagement and conversions, particularly for Newcastle upon Tyne’s mobile-savvy audience.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Newcastle upon Tyne?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We take security seriously and use SSL certificates, perform regular security audits, and implement advanced malware protection to ensure your Newcastle upon Tyne business website remains secure from cyber threats, protecting both your website and your customers data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Newcastle upon Tyne?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup as part of our web design services package, helping your Newcastle upon Tyne business establish a credible and professional online presence.
                  </div>
                </div>
              </div>
