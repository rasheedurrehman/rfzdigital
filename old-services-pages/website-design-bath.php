...
$meta_title = "Web Design Bath | Professional Website Design Services";
$meta_description = "Transform your online presence with our professional web design services in Bath. RFZ Digital creates stunning, SEO-friendly websites for businesses.";
$canonical_url = "https://rfzdigital.co.uk/website-design-bath";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design Bath</h1>
                    <h2 class="mb-3 service-hero-heading">Enhance your business presence in Bath with a  <span style="color:#1463FF; white-space:normal;">Professional Business Website </span></h2>
                    <p class="mb-3 services-hero-text">Our expert team specializes in creating responsive, SEO-optimized websites that ensure an outstanding user experience and boost your online visibility. Whether you're a new startup or an established business in Bath, we provide tailored web design solutions to help you connect with your local audience and distinguish yourself in a competitive market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Bath.webp" alt="Website Design Bath" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design dynamic, high-performance websites that offer quick load times, smooth animations, and a captivating visual experience.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We design protected web solutions with encryption and security protocols to keep hackers at bay.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that combine SEO strength and mobile usability for better customer engagement.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design websites that are easy to update, so you can make changes anytime without technical skills.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that don’t just look great but are also cost-effective, ensuring maximum return on your investment.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>Every decision we make in the design process is based on your preferences, ensuring a website that resonates with your business goals.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/13.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                ...
                <p>Let's build your Business digital future, get started today with RFZ Digital</p>
              </div>
