...
<?php
$meta_title = "Web Design Plymouth UK | Custom Website Design That Convert";
$meta_description = "Get a custom, responsive website designed for your business in Plymouth, UK. We build sleek, high-performing websites tailored to your business needs. Book Now!";
$canonical_url = "https://rfzdigital.co.uk/web-design-plymouth-uk";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web design Plymouth</h1>
                    <h2 class="mb-3 service-hero-heading">Step into the digital world with a website for <span style="color:#1463FF; white-space:normal;">Your Business</span></h2>
                    <p class="mb-3 services-hero-text">Strengthen your business presence in Plymouth with a professional business website. Our expert team designs responsive, SEO-optimised websites that deliver a smooth user experience and enhance your online visibility. Whether you are a new or an established business in Plymouth, we offer customised web design solutions that help you connect with your audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/plymouth.webp" alt="Web design Plymouth" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Empowering UK and Ireland Businesses with Engaging and Effective Website Design
                </h2>
                <p>
                  At RFZ Digital, we empower UK and Ireland businesses with engaging and effective website design that drives success. Our team creates responsive, user-friendly websites that enhance brand visibility, boost customer engagement, and support business growth.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <!-- <div class="icon">📈</div>  -->
        <h3>Professional Website Design</h3> <!-- Heading -->
        <p>We Design visually stunning Business websites that combine aesthetics with performance for a seamless user experience.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        <div class="feature-widget-2__icon">
                  <img src="./image/services/icons/Highly-Secured-Websites.svg" alt="Advanced Website Protection">
                </div>
        <!-- <div class="icon">🌐</div>  -->
        <h3>Advanced Website Protection</h3> <!-- Heading -->
        <p>We ensure your website is secured with the latest encryption, firewalls, and malware protection to keep hackers out.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites that load fast, look great on any device, and follow SEO best practices to boost your Business online.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Take full control of your website with our easy-to-use interface, making content updates smooth and stress-free.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>Transparent pricing with no hidden fees, get a Premium Business website at an Affordable price.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We focus on your business unique needs, providing customised solutions that drive real results.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/jrwfyjlzvcvqgqqtyxw1.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Supporting Businesses in UK, Ireland, and Across the Globe

                </h2>
                <p>At RFZ Digital, we offer SEO-optimised, high-performance website design to elevate your business online presence and drive growth. Our fast, mobile-friendly, and user-focused websites are crafted to attract customers, increase visibility, and maximise conversions.</p>
                <p>Serving businesses in the UK, Ireland, and globally, we build responsive, search engine-friendly websites that produce real, measurable results. Whether launching a new website or redesigning an existing one, our expert solutions are designed to help your business thrive in the digital age.</p>
                <p>Support your growth, partner with RFZ Digital today!
</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to design a website for my business in Plymouth?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Most websites are delivered within 2-4 weeks, with more complex websites taking 4-6 weeks. We ensure your Plymouth business website is completed on time, fully aligned with your business objectives and goals.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
               ...
               Do you offer local SEO services for businesses in Plymouth?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services for Plymouth businesses. Our strategies are tailored to increase your business website visibility in local Google results, helping you attract more customers from Plymouth and surrounding areas.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Plymouth?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to keep your Plymouth business website secure, up-to-date, and functioning at its best. This includes regular updates, security checks, and performance optimisation.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you design an e-commerce website for my business in Plymouth?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in designing secure, user-friendly e-commerce websites for businesses in Plymouth. Our e-commerce solutions are designed to optimise the shopping experience and increase online sales for your business.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Plymouth?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All of our websites are designed to be mobile-responsive, providing a seamless browsing experience for your Plymouth customers on smartphones, tablets, and desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Plymouth?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                   We implement SSL certificates, conduct regular security audits, and use advanced malware protection to ensure that your Plymouth business website remains secure from cyber threats, protecting both your website and customer data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Plymouth?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                 Yes, we offer professional email setup as part of our web design services. This will help your Plymouth business maintain a professional image and enable efficient communication with clients and partners.
                  </div>
                </div>
              </div>
