...
<section class="custom-bg">
        <div class="container">
            <div class="row align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="text-uppercase text-muted services-heading-h1" >Website Design Durham nc</h1>
                    <h2 class="mb-3">Your online success starts with a <span style="color:#318CB8; white-space:normal;">Professional Website</span></h2>
                    <p class="mb-4">Grow your business in Durham with a professional business website. Our expert team designs responsive, SEO-optimised websites that improve user experience and increase your online visibility. Whether you are a local startup or an established business in Durham, we provide customised web design solutions that help you connect with your audience and stand out in the competitive digital landscape.</p>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Delivering Website Design That Fuels Business Success Across the UK and Ireland
                </h2>
                <p>
                  At RFZ Digital, we deliver a website design that fuels business success across the UK and Ireland. Our expert team designs visually appealing, responsive websites that attract customers, enhance business identity, and drive growth.
                </p>
              </div>
        ...
        <div class="row row--custom">
          ...
          <div class="col-xl-6 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Delivering Innovation Across UK, Ireland, and Global Markets

                </h2>
                <p>At RFZ Digital, we drive business success with SEO-optimised, high-performance website design that enhances online visibility and customer engagement. Our fast, mobile-friendly, and conversion-driven websites are designed to attract traffic and improve user experience.</p>
                <p>Serving businesses in the UK, Ireland, and worldwide, we specialise in creating responsive, search engine-friendly websites that boost rankings and support growth. Whether launching a new website or revamping an existing one, our expert solutions are designed to meet your unique business needs.</p>
                <p>Experience innovation and elevate your digital presence, partner with RFZ Digital today!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                Why should I choose your website Design services in Durham?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  We provide affordable, high-quality website Design services starting at £499 for businesses in Durham. Our websites are mobile-responsive, SEO-optimised, and professionally designed to help local businesses increase their online visibility and attract more customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How long does it take to Design a website for my business in Durham?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  For most websites, the website design time is 2-4 weeks, while more complex projects may take 4-6 weeks. We ensure that your website for your Durham business is delivered on time and meets your specific requirements.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Durham?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer local SEO services tailored to businesses in Durham. Our SEO strategies are designed to improve your website search engine ranking, helping you attract more customers from the local area and stand out in Durham competitive market.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Durham?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer comprehensive website maintenance services, including regular updates, security monitoring, and performance optimisation, to ensure your Durham based business website stays secure and functions smoothly.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Durham?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure, user-friendly e-commerce websites for businesses in Durham. Our solutions are designed to optimise your sales, enhance the customer experience, and ensure a smooth shopping journey for your customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Durham?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    Yes, all of our websites are mobile-responsive, ensuring that your website looks great and functions perfectly on all devices, including smartphones, tablets, and desktops, which is essential for Durham customers who browse on mobile devices.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Durham?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  We implement SSL certificates, conduct regular security audits, and use malware protection to ensure your website is secure. These measures help protect your Durham business website from cyber threats and safeguard your data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Durham?
                </button>
                <div id="home-1-faq-item-8" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we can set up professional email accounts as part of our web design services. This helps your Durham business maintain a professional communication channel with clients and partners.
                  </div>
                </div>
              </div>
            </div>
