...
<?php
$meta_title = "Website Design Kettering | Website Development | RFZ Digital";
$meta_description = "RFZ Digital specializes in website design and development in Kettering. Partner with us to create a stunning online presence that drives results for your brand.";
$canonical_url = "https://rfzdigital.co.uk/web-design-kettering";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design kettering</h1>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/kettering.webp" alt="Website Design kettering" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design modern, high-quality websites that combine design with functionality, ensuring a seamless user experience.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        <div class="feature-widget-2__icon">
                  <img src="./image/services/icons/Highly-Secured-Websites.svg" alt="Trusted Website Security">
                </div>
        <!-- <div class="icon">🌐</div>  -->
        <h3>Trusted Website Security</h3> <!-- Heading -->
        <p>With our expert security solutions, your website remains protected against malware, phishing, and cyberattacks.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We design websites with SEO in mind, ensuring higher rankings while providing a flawless experience on mobile and desktop.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Stay in control of your website with our simple yet powerful content management system, designed for ease.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We design user-friendly, SEO-optimised websites that are cost-effective and result-driven.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We take a client-first approach, offering customised solutions that fit your needs perfectly.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/qvnwvcrk7fw9driypxpp.webp" alt="Website Design">
            </div>
          </div>
