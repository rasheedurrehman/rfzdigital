<?php 
$meta_title = "Terms & Conditions - RFZ Digital";
$meta_description = "We reserve the right to refuse service to anyone for any reason at any time.";
$canonical_url = "https://rfzdigital.co.uk/terms-conditions";

include 'includes/header.php'; 
?>


    <div class="container mt-4 privacy-page" style="padding-top: 120px;">
        <h1 class="text-center">Terms & Conditions</h1>
        <p class="text-muted text-center">Last updated: Jan 10, 2025</p>

        <section class="my-4">
            <h3>Overview</h3>
            <p>
                This website is operated by RFZ Digital. Throughout the site, the terms “we”, “us” and “our” refer to RFZ Digital. RFZ Digital offers this website, including all information, tools, and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
            </p>
            <p>
        ...
        <section class="my-4 privacy-policy-page">
        ...
        <section class="my-4 privacy-policy-page">
            <h3>Modifications to the Services and Prices</h3>
            <p>
        ...
        <section class="my-4">
            ...
            <p>
                We may, but have no obligation to, monitor, edit or remove content that we determine in our sole discretion are unlawful, offensive, threatening, libelous, defamatory, pornographic, obscene or otherwise objectionable or violates any party’s intellectual property or these Terms and Conditions. If, at our request, you send certain specific submissions (for example contest entries) or without a request from us you send creative ideas, suggestions, proposals, plans, or other materials, whether online, by email, by postal mail, or otherwise (collectively, 'comments'), you agree that we may, at any time, without restriction, edit, copy, publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We are and shall be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) to respond to any comments.
            </p>
            <p>
        ...
        <section class="my-4 privacy-policy-page">
            ...
            <p>
                Your submission of personal information through the site is governed by our <a href="<?php echo BASE_URL; ?>privacy-policy">Privacy Policy</a> .
            </p>
        </section>
        <section class="my-4 privacy-policy-page">
        ...
        <section class="my-4 privacy-policy-page">
            <h3>Disclaimer of Warranties; Limitations of Liability</h3>
            <p>
        ...
        <section class="my-4 privacy-policy-page">
            ...
            <p>
                You agree to indemnify, defend and hold harmless RFZ Digital and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms and Conditions or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        ...
        <section class="my-4 privacy-policy-page">
            ...
            <p>
             Questions about the Terms and Conditions should be sent to us at <a href="mailto:info@rfzdigital.co.uk">info@rfzdigital.co.uk</a>.
            </p>
