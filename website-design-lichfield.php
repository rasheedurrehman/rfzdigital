...
<?php
$noindex = true;
$meta_title = "Website Design Lichfield | Website Development | RFZ Digital";
$meta_description = "Looking for web design in Lichfield? Our expert team builds Professional, high-quality, SEO-friendly sites to grow your online presence. Get a free quote!";
$canonical_url = "https://rfzdigital.co.uk/website-design-lichfield";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web design Lichfield</h1>
                    <h2 class="mb-3 service-hero-heading">Build a website that Grows your  <span style="color:#1463FF; white-space:normal;">Business Online </span></h2>
                    <p class="mb-3 services-hero-text">Grow your business in Lichfield with a professional business website. Our expert team designs responsive, SEO-optimised websites that provide an excellent user experience and boost your online presence. Whether you are a startup or an established business in Lichfield, we offer customised web design solutions that help you connect with your local audience and stand out in a competitive market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/belfast.webp" alt="Web design Lichfield" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Professional Website Design for UK and Ireland Businesses Looking to Lead Online
                </h2>
                <p>
                 At RFZ Digital, we offer professional website design services for UK and Ireland businesses aiming to lead online. Our expert team designs responsive, visually captivating websites that boost your business presence, engage customers and drive business success.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design professional, fast-performing websites that help businesses gain credibility and convert visitors into customers.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Safe, Secure Websites solutions</h5> <!-- Heading -->
        <p>We ensure complete business website security with encryption, authentication, and monitoring.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We build high-performance websites that are fast, responsive, and optimised for search engines.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Managing your website should be simple, which is why our intuitive dashboard allows quick and easy content modifications.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>Our affordable pricing lets you enjoy premium website design without the premium price tag.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We prioritise your business goals and customer needs, ensuring your business website not only looks great but also delivers measurable success.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/52.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Powering Businesses Across UK, Ireland, and Beyond

                </h2>
                <p>At RFZ Digital, we deliver SEO-optimised, high-performance website design that fuels business growth. Our fast, mobile-friendly, and conversion-focused websites enhance online visibility, attract customers, and boost engagement.</p>
                <p>Serving businesses in the UK, Ireland, and beyond, we create responsive, search engine-friendly websites that improve rankings and deliver real results. Whether launching a new website or revamping an existing one, our expert solutions are tailored to meet your business needs and help you succeed in </p>
                <p>Empower your business, partner with RFZ Digital today!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to design a website for my business in Lichfield?
                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  For most websites, we complete the project within 2-4 weeks. More complex websites may take 4-6 weeks to ensure high-quality results. We focus on delivering websites that meet your business needs and are optimised for Lichfield local market.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Lichfield?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO strategies that help businesses in Lichfield rank higher in local search results. This ensures that your Lichfield business can reach a larger audience and attract more local customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Lichfield?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer comprehensive website maintenance services, including regular updates, performance monitoring, and security checks, ensuring your Lichfield business website remains secure and functions smoothly.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you design an e-commerce website for my business in Lichfield?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we design secure, easy-to-navigate e-commerce websites for businesses in Lichfield. Our solutions are designed to increase sales and provide a seamless shopping experience for your customers.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Lichfield?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All our websites are mobile-responsive, meaning they will look great and function properly on smartphones, tablets, and desktops. This ensures a seamless browsing experience for your Lichfield customers, no matter the device they use.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Lichfield?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We use SSL certificates, conduct regular security audits, and implement malware protection to secure your Lichfield business website from online threats. This protects both your website and your customers sensitive information.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Lichfield?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup services as part of our web design services package. This helps your Lichfield business maintain a professional communication channel with clients and partners, improving your business credibility.
                  </div>
                </div>
              </div>
