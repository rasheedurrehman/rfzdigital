...
$meta_title = "Web Design Cardiff | Custom Website Design | RFZ Digital";
$meta_description = "Custom web design in Cardiff that drives leads & sales! RFZ Digital delivers modern, mobile-friendly sites tailored to your business. Get started today!";
$canonical_url = "https://rfzdigital.co.uk/web-design-cardiff";
...
@media (max-width: 600px) { /* Mobile View */
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web Design Cardiff</h1>
                    <h2 class="mb-3 service-hero-heading">Modern websites designed for <span style="color:#1463FF; white-space:normal;">Growing Businesses </span></h2>
                    <p class="mb-3 services-hero-text">Strengthen your business presence in Cardiff with a professional website. Our expert team designs responsive, SEO-optimised websites that deliver a seamless user experience and improve your online visibility. Whether you're a new business or an established brand in Cardiff, we provide customised web design solutions that help you connect with your audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Cardiff.webp" alt="Web Design Cardiff" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Helping UK and Ireland Companies Stand Out Online with Professional Website Design
                </h2>
                <p>
                  At RFZ Digital, we help UK and Ireland companies stand out online with professional website design. Our team designs responsive, visually appealing websites that reflect your business identity, improve user engagement, and drive business success.
                </p>
              </div>
...
<div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design sleek, high-speed websites that ensure smooth navigation, intuitive layouts, and a flawless digital experience.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>High-Level Web Security</h5> <!-- Heading -->
        <p>We provide web security solutions that ensure safe browsing and data privacy for your users.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We develop websites that rank higher on search engines and provide an outstanding experience on mobile devices.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We build websites that let you edit text, add new pages, and update images with just a few clicks.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>No need to overspend, Our web design services offer top-tier quality at a price that suits your budget.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We blend innovation with your business essence, ensuring a website that is both visually compelling and functionally robust.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-auto col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/30.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-6 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Seamlessly Connecting UK, Ireland, and Global Businesses
                </h2>
                <p>At RFZ Digital, we offer SEO-optimised, high-performance website design that connects businesses in the UK, Ireland, and across the globe. Our fast, mobile-friendly, and user-centric websites are designed to enhance visibility, boost engagement, and drive conversions, ensuring your business thrives in an interconnected world.</p>
                <p>IWith expertise in creating responsive, search engine-friendly websites, we deliver long-term, impactful results for businesses of all sizes. Whether launching a new website or revamping an existing one, our solutions seamlessly integrate with your business goals, empowering you to succeed on a global scale.</p>
                <p>Partner with RFZ Digital today to seamlessly connect your business across borders and unlock new growth opportunities!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Cardiff?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  The typical development time for a website is 2-4 weeks, but for more complex projects, it may take 4-6 weeks. We work closely with you throughout the process to ensure your Cardiff business website is completed on time and meets all your requirements.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Cardiff?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                 Yes, we specialise in local SEO services for businesses in Cardiff. Our SEO strategies are aimed to improve your website visibility in local search results, helping your business rank higher and attract more customers in Cardiff.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Cardiff?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to ensure your Cardiff business website stays secure, updated, and fully functional. Our maintenance services include regular updates, security checks, and performance monitoring.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Cardiff?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we design secure and user-friendly e-commerce websites for businesses in Cardiff. Our e-commerce solutions are designed to improve the shopping experience and increase online sales for your Cardiff-based business.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Cardiff?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! All the websites we create are mobile-responsive. This means your Cardiff customers will have an optimised experience whether they are browsing on a smartphone, tablet, or desktop.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Cardiff?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, conduct regular security audits, and use advanced malware protection to secure your Cardiff business website. These measures help safeguard both your website and customer data from potential threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Cardiff?

                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup services as part of our web development offerings. This ensures that your Cardiff business communicates effectively and maintains a professional image with clients, partners, and customers.
                  </div>
                </div>
              </div>
