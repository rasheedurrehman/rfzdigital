...
$meta_title = "Web Design Dundee | Professional Website Services";
$meta_description = "Professional website design services for Dundee businesses. RFZ Digital design modern, SEO-friendly websites that engage Scottish audiences. ";
$canonical_url = "https://rfzdigital.co.uk/web-design-dundee";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web Design Dundee</h1>
                    <h2 class="mb-3 service-hero-heading">Create a powerful online presence with a professional <span style="color:#1463FF; white-space:normal;">Website Design </span></h2>
                    <p class="mb-3 services-hero-text">Enhance your business presence in Dundee with a professional website. Our expert team designs responsive, SEO-optimised websites that provide an exceptional user experience and boost your online visibility. Whether you arenew business or an established brand in Dundee, we offer customised web design solutions that help you engage with your local audience and stand out in a competitive market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Dundee.webp" alt="Web Design Dundee" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Delivering Cutting Edge Website Design Solutions to Strengthen UK and Ireland Brands

                </h2>
                <p>
                  At RFZ Digital, we deliver cutting-edge website design solutions to strengthen UK and Ireland brands. Our expert team designs responsive, innovative websites that enhance user engagement, showcase your brand, and drive growth.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design innovative, high-performance websites that load fast, look professional, and function flawlessly on all devices.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Ultra Secure Websites</h5> <!-- Heading -->
        <p>We prioritise security in every website we design, protecting data, transactions, and user privacy.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We ensure your website is structured for SEO success and mobile-first indexing for better Google rankings.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We create websites that allow you to handle all updates quickly, so your business always stays current online.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>We believe in transparent, affordable pricing, offering professional websites without hidden costs or surprises.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We work as an extension of your team, collaborating with you to develop a website that truly represents your Business.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/23.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Seamless Digital Services Across UK, Ireland, and Worldwide

                </h2>
                <p>At RFZ Digital, we offer SEO-optimised, high-performance website design that drives business success in the digital world. Our fast, mobile-friendly, and user-focused websites are designed to enhance your online presence, engage visitors, and increase conversions.</p>
                <p>With expertise in serving businesses across the UK, Ireland, and globally, we create responsive, search engine-friendly websites that deliver measurable, long-term results. Whether launching a new website or revamping an existing one, our seamless digital services are designed to support your business growth at every step.</p>
                <p>Partner with RFZ Digital today for seamless digital solutions that elevate your business locally and globally!
</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Dundee?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Typically, websites are completed within 2-4 weeks. More complex projects may take 4-6 weeks. We work closely with you to ensure your Dundee business website is delivered on time, meeting all your needs.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Dundee?

                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer local SEO services specifically for businesses in Dundee. Our strategies help improve your website visibility in local search results, making it easier for customers in Dundee to find your business.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Dundee?

                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to keep your Dundee business website secure, updated, and functioning properly. Our services include regular updates, security checks, and performance optimisations.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Dundee?

                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in designing secure and user-friendly e-commerce websites for businesses in Dundee. Our e-commerce solutions are designed to enhance the shopping experience and help you increase sales and grow your online presence.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Dundee?

                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, every website we create is mobile-responsive. This ensures that your customers in Dundee have a smooth browsing experience on smartphones, tablets, and desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Dundee?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, perform regular security audits, and use advanced malware protection to ensure that your Dundee business website is secure. This helps protect your site and customer data from cyber threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Dundee?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup as part of our web development services. This ensures that your Dundee business maintains a professional image and communicates efficiently with clients, partners, and customers.
                  </div>
                </div>
              </div>
