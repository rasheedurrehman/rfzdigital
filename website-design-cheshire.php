...
$meta_title = "Website Design Cheshire: Web Design Agency in UK & Ireland";
$meta_description = "Get a professional website design in Cheshire. RFZ Digital designs and develops responsive, and SEO-friendly websites tailored to your business needs.";
$canonical_url = "https://rfzdigital.co.uk/website-design-cheshire";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design Cheshire</h1>
                    <h2 class="mb-3 service-hero-heading">Build your business online presence with a <span style="color:#1463FF; white-space:normal;">Professional Website </span></h2>
                    <p class="mb-3 services-hero-text">Enhance your business online presence with a Professional and mobile-friendly website tailored for success in the dynamic Cheshire market. Our experienced team combines creativity with SEO-driven strategy to build high-performing websites that not only look exceptional but also deliver measurable results. Whether you're a startup or a growing business, we focus on user experience, speed, and performance — helping you stand out and grow confidently in Cheshire's competitive digital landscape.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/cheshire.webp" alt="Website Design Cheshire" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Empowering Local Success with Website Design Solutions for UK and Ireland Businesses
                </h2>
                <p>
                  At RFZ Digital, we empower local success for UK and Ireland businesses with website design solutions that drive growth and visibility. Our team creates customised, user-friendly websites that enhance your online presence and attract more customers. Let us help you build a strong, local digital presence that stands out.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design user-focused, performance-driven websites that deliver superior speed, responsiveness, and reliability.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Top-Level Cybersecurity</h5> <!-- Heading -->
        <p>We design websites with advanced security layers, keeping your business and customers protected.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We develop websites that are both mobile-friendly and SEO-optimised for higher engagement.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Our websites are built for simplicity, ensuring you can edit text, change visuals, and manage your content with just a few clicks.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>Our transparent pricing ensures you get a feature-rich business website at a price that works for you.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We prioritise your goals, creating websites that are visually stunning, user-friendly, and high-performing.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/41.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital – Elevating Digital Growth for Businesses in Cheshire
                </h2>
                <p>At RFZ Digital, we create SEO-optimised, high-performance websites that help Cheshire businesses thrive online. Our websites are fast, mobile-responsive, and built with the user in mind — designed to increase visibility, attract the right audience, and convert clicks into customers.</p>
                <p>Proudly serving businesses across Cheshire, we specialise in responsive, search engine-friendly web design tailored to the local market. Whether you're building a brand-new site or revamping your current one, our expert solutions are crafted for real results.</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Cheshire?
                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Our Typically, websites are completed within 2–4 weeks. More complex projects may take 4–6 weeks. We work closely with you throughout the process to ensure your Cheshire business website is delivered on time and meets your expectations.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Cheshire?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services for businesses in Cheshire. Our SEO strategies help improve your website’s ranking in local search results, making it easier for customers in Cheshire to find your business online.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for businesses in Cheshire?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to ensure your Cheshire business website stays secure, updated, and performs at its best. This includes regular updates, security monitoring, and performance optimisations.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Cheshire?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we create secure and user-friendly e-commerce websites for businesses in Cheshire. Our e-commerce solutions are designed to enhance the online shopping experience and help you increase sales and grow your business.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Cheshire?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all websites we create are mobile-responsive, ensuring that your customers in Cheshire have an optimal browsing experience across all devices, whether they are using smartphones, tablets, or desktops.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Cheshire?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, perform regular security audits, and use advanced malware protection to ensure that your Cheshire business website is secure. This helps protect your site and customer data from potential cyber threats.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Cheshire?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide professional email setup as part of our web development services. This helps your Cheshire business maintain a professional image and ensures efficient communication with clients, partners, and customers.
                  </div>
                </div>
              </div>
