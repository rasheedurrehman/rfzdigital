      ...
      <div class="col-xxl-auto col-lg-6 col-md-7 col-sm-8 col-10" data-aos-duration="1000" data-aos="fade-left" data-aos-delay="300">
        <div class="home-1_hero-image-block">
          <div class="home-1_hero-image">
            <img src="./image/web-dev/Website-Development-Hero-Image.webp" alt="hero image">
          </div>
        </div>
      </div>
        ...
        <div class="home-1_hero-content">
          <div class="home-1_hero-content-text">
            <h1 class="hero-content__title heading-xxl ">
              Services Page  <span class="country-background"></span>
            </h1>
            <p>
               A professional website is essential for growing your business online across the UK and Ireland. Our affordable packages start from just £499, delivering a Professional, mobile-friendly, and fully optimised website that helps you stand out and attract more customers.
            </p>
          </div>
