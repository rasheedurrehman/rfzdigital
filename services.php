...
<section class="custom-bg">
  <div class="container">
    <div class="row align-items-center">
      <!-- Left Column -->
      <div class="col-md-6">
        <h6 class="text-uppercase text-muted">Digital Strategy Consulting</h6>
        <h2 class="mb-3">Drive Growth and Engagement with <span
            style="color:#318CB8; white-space:normal;">Digital Strategy consulting.</span></h2>
        <p class="mb-4">Elevate your business with RFZ Digital! With our Digital Strategy Consulting, your
          business will have a clear roadmap to success. We combine deep market insights with innovative
          strategies that drive growth and engagement. Our expert consultants work with your team to identify
          opportunities and challenges, so you make informed decisions that yield maximum results. Let’s
          empower your business to thrive in a constantly evolving digital world!</p>
        <a href="#" class="btn btn-primary">Click Here</a>
      </div>
      <!-- Right Column -->
      <div class="col-md-6 d-flex justify-content-center">
        <img src="./image/Digital-Strategy-Consulting-2-1-2048x1781.webp" alt="Placeholder Image"
