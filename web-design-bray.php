...
<?php
$noindex = true;
$meta_title = "Web Design Bray | Website Design Experts | RFZ Digital";
$meta_description = "Grow your business with expert web design in Bray. Get a professional, fast, SEO-friendly, and high-performing website today to drive real results. Contact Us!";
$canonical_url = "https://rfzdigital.co.uk/web-design-bray";
...
@media (max-width: 600px) { /* Mobile View */
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Web Design Bray</h1>
                    <h2 class="mb-3 service-hero-heading">We offer website design that elevates your <span style="color:#1463FF; white-space:normal;">Business Online Presence </span></h2>
                    <p class="mb-3 services-hero-text">Enhance your business presence in Bray with a professional website. Our expert team designs responsive, SEO-optimised websites that provide a smooth user experience and boost your online visibility. Whether you're a new business or an established brand in Bray, we offer customised web design solutions that help you connect with your local audience and stand out in a competitive digital market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Bray.webp" alt="Web Design Bray" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Designing Custom Websites to Empower UK and Ireland Businesses in the Digital World
                </h2>
                <p>
                  At RFZ Digital, we design custom websites that empower UK and Ireland businesses in the digital world. Our team designs responsive websites that reflect your unique brand and provide an exceptional user experience.
                </p>
              </div>
...
<div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <!-- <div class="icon">📈</div>  -->
        <h5>User friendly Web Design</h5> <!-- Heading -->
        <p>We design fast, conversion-focused business websites that turn visitors into loyal customers.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Trusted Web Security</h5> <!-- Heading -->
        <p>We ensure a secure browsing experience for your customers with strict data protection measures and secure hosting.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We optimise your website for speed, search rankings, and mobile compatibility, making it easier for customers to find and interact with your business.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Manage your website stress-free with our user-friendly dashboard, giving you full control over edits, updates, and new content.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>High-quality websites shouldn’t be expensive. Our affordable services make professional web design accessible.</p>
      </div>
    </div>
    ...
    <div class="col" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We are committed to designing websites that provide a seamless user experience, ensuring your visitors stay engaged and take action.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/65.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Your Global Digital Partner with Roots in Ireland and UK

                </h2>
                <p>At RFZ Digital, we combine local expertise with global reach, offering innovative digital solutions that fuel business success. With a deep understanding of the unique needs of businesses in the UK, Ireland, and beyond, we provide cutting-edge web development, SEO optimisation, and digital marketing strategies tailored for measurable results.</p>
                <p>Our team is dedicated to empowering businesses with forward-thinking technology and a strategic approach to help them grow and excel in an increasingly digital world. Whether you’re a small startup or a large enterprise, we ensure your digital journey leads to success.</p>
                <p>Let RFZ Digital be your partner in driving digital excellence across the UK, Ireland, and the globe!</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Bray?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  The typical timeframe for website development is 2-4 weeks, depending on the complexity of the project. More advanced websites may take 4-6 weeks. We ensure clear communication throughout the process to deliver a site that meets your business needs in Bray.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Bray?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in local SEO services for businesses in Bray. Our strategies are designed to help your website rank higher in local search results, attract more customers from Bray, and drive organic traffic to your site.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you provide website maintenance services for busines
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services to ensure that your site remains up-to-date, secure, and performs optimally. This includes regular updates, security checks, and any necessary fixes to keep your website functioning smoothly.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Bray?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we specialise in building secure, user-friendly e-commerce websites for businesses in Bray. Our e-commerce solutions are designed to provide a seamless shopping experience, increase conversions, and help your online store grow effectively.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Bray?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all the websites we develop are mobile-responsive. This ensures that customers in Bray can easily browse your site on their smartphones, tablets, or desktops, providing an optimal experience across all devices.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Bray?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We take website security seriously by implementing SSL certificates, conducting regular security audits, and using advanced malware protection. These measures protect your website from cyber threats and safeguard your customer data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for my business in Bray?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, as part of our web development services, we can set up professional email accounts for your business in Bray. This improves communication with your customers and gives your business a professional image.
                  </div>
                </div>
              </div>
