...
$meta_title = "Website Design Derby | Creative Website Design";
$meta_description = "Upgrade your website design for Derby businesses. RFZ Digital combines creativity with technical excellence to boost your sales. Get your free proposal.";
$canonical_url = "https://rfzdigital.co.uk/website-design-derby";
...
span {
    ...
    <section class="custom-bg">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <h1 class="text-uppercase text-muted service-hero-h1">Website Design Derby</h1>
                    <h2 class="mb-3 service-hero-heading">Enhance your digital footprint with a <span style="color:#1463FF; white-space:normal;">Professional Website </span></h2>
                    <p class="mb-3 services-hero-text">Strengthen your business presence in Derby with a professional website. Our expert team designs responsive, SEO-optimised websites that ensure an excellent user experience and increase your visibility online. Whether you're a new business or an established brand in Derby, we offer customised web design solutions to help you engage with your local audience and thrive in a competitive market.</p>
            ...
            <div class="col-md-5 d-flex justify-content-end">
                    <img src="./image/services/hero-section/Derby.webp" alt="Website Design Derby" class="img-fluid rounded  ">
                </div>
        </div>
    </div>
    </section>
            ...
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  Designing Websites that Help UK and Ireland Businesses Stand Out Online
                </h2>
                <p>
                  At RFZ Digital, we design websites that help UK and Ireland businesses stand out online. Our team designs visually captivating and user-friendly websites that enhance your business digital presence and attract and engage customers.
                </p>
              </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>We design fast, engaging websites that ensure smooth functionality, easy navigation, and an attractive design for maximum impact.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <!-- <div class="icon">🌐</div>  -->
        <h5>Fully Secured Websites</h5> <!-- Heading -->
        <p>We implement advanced security measures to ensure your website stays protected against online threats.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>We deliver business websites that load fast, rank high, and work seamlessly on all mobile devices.</p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row g-4">
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
      <div class="service-page-custom-box">
        ...
        <p>Managing your website is as simple as updating a social media profile, thanks to our easy-to-use platform.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
      <div class="service-page-custom-box" >
        ...
        <p>Get a high-performing website at a cost that makes sense for small businesses and startups.</p>
      </div>
    </div>
    ...
    <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
      <div class="service-page-custom-box" >
        ...
        <p>Our approach is all about collaboration. We listen to your ideas and turn them into a functional, high-performing website.</p>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="row row--custom">
          <div class="col-xl-4 col-lg-5 col-auto" data-aos-duration="1000" data-aos="fade-left">
            <div class="home-2_content-image-2 content-image--mobile-width">
              <img src="./image/services/last-section/6.webp" alt="Website Design">
            </div>
          </div>
          <div class="col-xl-8 col-lg-7 col-md-10 col-auto" data-aos-duration="1000" data-aos="fade-right">
            <div class="content">
              <div class="content-text-block">
                <h2 class="content-title heading-md text-black">
                  RFZ Digital - Revolutionising Businesses in UK, Ireland, and the World

                </h2>
                <p>At RFZ Digital, we drive digital success with SEO-optimised, high-performance website design tailored for growth. Our fast, mobile-friendly, and conversion-focused websites enhance online visibility, attract customers, and maximise engagement.</p>
                <p>Serving businesses across the UK, Ireland, and beyond, we create responsive, search engine-friendly websites that boost rankings and deliver real results. Whether you're launching a new site or upgrading an existing one, we provide expert solutions to help your business thrive.</p>
                <p>Step into the future, partner with RFZ Digital today!
</p>
              </div>
          ...
          <div class="col-lg-10">
            <div class="accordion-style-1" id="home-1-faq">
              <div class="accordion-item">
                ...
                How long does it take to develop a website for my business in Derby?

                </button>
                <div id="home-1-faq-item" class="accordion-collapse collapse show" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  The development of a standard website typically takes 2-4 weeks. For more complex projects, it may take 4-6 weeks. We prioritise timely delivery without compromising the quality of the website for Derby businesses.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer local SEO services for businesses in Derby?
                </button>
                <div id="home-1-faq-item-2" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we provide local SEO services to help businesses in Derby rank higher on search engines. Our SEO strategies help increase your online visibility and drive local traffic, ensuring your business attracts more customers from the Derby area.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Do you offer website maintenance services for businesses in Derby?
                </button>
                <div id="home-1-faq-item-3" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer ongoing website maintenance services that include regular updates, security monitoring, and performance optimisation, ensuring your Derby based website remains secure and fully functional.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you build an e-commerce website for my business in Derby?
                </button>
                <div id="home-1-faq-item-4" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Absolutely! We design and develop e-commerce websites that are secure, user-friendly, and optimised to drive sales. Our e-commerce solutions are perfect for Derby businesses looking to expand their online sales.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Will my website be mobile-friendly for customers in Derby?
                </button>
                <div id="home-1-faq-item-5" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, all our websites are fully mobile-responsive. This means your business website will provide a seamless experience for your customers, whether they are browsing from a smartphone, tablet, or desktop, ensuring optimal accessibility for Derby based users.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                How do you ensure website security for businesses in Derby?
                </button>
                <div id="home-1-faq-item-6" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                    We implement SSL certificates, malware protection, and regular security audits to ensure your Derby business website is secure. These measures protect your business website from cyber threats and safeguard your business data.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                Can you set up professional email accounts for businesses in Derby?
                </button>
                <div id="home-1-faq-item-7" class="accordion-collapse collapse" data-bs-parent="#home-1-faq">
                  <div class="accordion-item__body">
                  Yes, we offer professional email setup services as part of our web development package. This enables your Derby business to communicate effectively with clients and partners while maintaining a professional image.
                  </div>
                </div>
              </div>
